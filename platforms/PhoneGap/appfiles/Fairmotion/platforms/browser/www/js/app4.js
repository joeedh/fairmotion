es6_module_define('UITextBox', ["UIWidgets", "events", "UIElement", "UIPack", "mathlib", "UIFrame"], function _UITextBox_module(_es6_module) {
  var $_mh;
  var $_swapt;
...
es6_module_define('ScreenKeyboard', ["UIFrame", "UIWidgets", "UIElement", "UIPack", "events"], function _ScreenKeyboard_module(_es6_module) {
  var PackFlags=es6_import_item(_es6_module, 'UIElement', 'PackFlags');
  var KeyMap=es6_import_item(_es6_module, 'events', 'KeyMap');
  var ToolKeyHandler=es6_import_item(_es6_module, 'events', 'ToolKeyHandler');
  var FuncKeyHandler=es6_import_item(_es6_module, 'events', 'FuncKeyHandler');
...
es6_module_define('UIMenu', ["UIFrame", "UIPack", "events", "mathlib", "toolops_api", "UITextBox", "UIWidgets", "UIElement"], function _UIMenu_module(_es6_module) {
  var UIElement=es6_import_item(_es6_module, 'UIElement', 'UIElement');
  var PackFlags=es6_import_item(_es6_module, 'UIElement', 'PackFlags');
  var UIFlags=es6_import_item(_es6_module, 'UIElement', 'UIFlags');
  var CanvasFlags=es6_import_item(_es6_module, 'UIElement', 'CanvasFlags');
...
es6_module_define('RadialMenu', ["UIElement", "toolops_api", "mathlib", "UIPack", "UITextBox", "UIWidgets", "UIFrame", "events"], function _RadialMenu_module(_es6_module) {
  var MinMax=es6_import_item(_es6_module, 'mathlib', 'MinMax');
  var aabb_isect_2d=es6_import_item(_es6_module, 'mathlib', 'aabb_isect_2d');
  var inrect_2d=es6_import_item(_es6_module, 'mathlib', 'inrect_2d');
  var UIElement=es6_import_item(_es6_module, 'UIElement', 'UIElement');
...
es6_module_define('UIWidgets_special', ["UIMenu", "colorutils", "UIPack", "UIWidgets", "mathlib", "events", "UITextBox", "UIFrame", "UIElement"], function _UIWidgets_special_module(_es6_module) {
  var MinMax=es6_import_item(_es6_module, 'mathlib', 'MinMax');
  var inrect_2d=es6_import_item(_es6_module, 'mathlib', 'inrect_2d');
  var aabb_isect_2d=es6_import_item(_es6_module, 'mathlib', 'aabb_isect_2d');
  var UIElement=es6_import_item(_es6_module, 'UIElement', 'UIElement');
  ...
  var $ret_hGHK=undefined;
  function get_editor_list() {
    if ($ret_hGHK==undefined) {
        $ret_hGHK = new GArray();
  ...
  var $pos_JC1m_do_mouse;
  var $mpos_3M3u_do_mouse;
  var $sz_8RIG_build_draw;
  var $v1_8ffi_build_draw;
  var $v3_PMw7_build_draw;
  var $clr_6BCs_build_draw;
  var $pos1_YJbm_build_draw;
  var $size_pZXP_do_mouse;
  var $v2_lQC0_build_draw;
  var $v4_N3FW_build_draw;
  var UIColorField=_ESClass("UIColorField", UIElement, [function UIColorField(ctx, callback) {
    ...
    $mpos_3M3u_do_mouse[0] = event.x;
    $mpos_3M3u_do_mouse[1] = event.y;
    if (this.mode=="h") {
        this.h = ($mpos_3M3u_do_mouse[0]-7)/(this.size[0]-12-2);
      ...
      if (this.mode=="sv") {
        var v=$mpos_3M3u_do_mouse[0]/this.size[0];
        v = Math.sqrt(v);
        var s=($mpos_3M3u_do_mouse[1]-this.huehgt+2)/(this.size[1]-this.huehgt);
    ...
    var cs=_hue_field;
    var segs=cs.length;
    var wid=Math.ceil((this.size[0]-2-$sz_8RIG_build_draw[0])/cs.length);
    var h=this.h, s=this.s, v=this.v;
    var halfx=Math.floor($sz_8RIG_build_draw[0]*0.5);
    ...
    for (var i=0; i<segs; i++) {
        ...
        $v1_8ffi_build_draw[0] = i*wid+1+halfx;
        $v1_8ffi_build_draw[1] = 1;
        $v2_lQC0_build_draw[0] = i*wid+1+halfx;
        $v2_lQC0_build_draw[1] = y;
        $v3_PMw7_build_draw[0] = i*wid+wid+1+halfx;
        $v3_PMw7_build_draw[1] = y;
        $v4_N3FW_build_draw[0] = i*wid+wid+1+halfx, $v4_N3FW_build_draw[1] = 1;
        canvas.quad($v2_lQC0_build_draw, $v3_PMw7_build_draw, $v4_N3FW_build_draw, $v1_8ffi_build_draw, c1, c2, c3, c4, true);
    }
    canvas.quad($v4_N3FW_build_draw, $v3_PMw7_build_draw, [this.size[0]-1, y], [this.size[0]-1, 1], cs[0]);
    $v1_8ffi_build_draw[0] = 0;
    $v1_8ffi_build_draw[1] = y+2;
    $v2_lQC0_build_draw[0] = 0;
    $v2_lQC0_build_draw[1] = this.size[1];
    $v3_PMw7_build_draw[0] = this.size[0];
    $v3_PMw7_build_draw[1] = this.size[1];
    $v4_N3FW_build_draw[0] = this.size[0];
    $v4_N3FW_build_draw[1] = 27;
    ...
    if (t<0||t>1)
      t = 0;
    for (var i=0; i<3; i++) {
        $clr_6BCs_build_draw[i] = cs[h1][i]+(cs[h2][i]-cs[h1][i])*t;
    }
    c1 = [0, 0, 0, 1];
    c2 = [0, 0, 0, 1];
    c3 = $clr_6BCs_build_draw;
    c4 = [1, 1, 1, 1];
    canvas.colorfield([0, this.huehgt], [this.size[0], this.size[1]-this.huehgt], $clr_6BCs_build_draw);
    $pos1_YJbm_build_draw[0] = Math.floor(1+h*(this.size[0]-2-$sz_8RIG_build_draw[0]));
    $pos1_YJbm_build_draw[1] = Math.floor(y*0.5-$sz_8RIG_build_draw[1]*0.5);
    canvas.box($pos1_YJbm_build_draw, $sz_8RIG_build_draw);
    $pos1_YJbm_build_draw[0] = Math.floor((this.size[0]-$sz_8RIG_build_draw[0])*v*v);
    $pos1_YJbm_build_draw[1] = Math.floor((this.size[1]-y-4)*s+y+2-$sz_8RIG_build_draw[1]*0.5);
    canvas.box($pos1_YJbm_build_draw, $sz_8RIG_build_draw);
  }]);
  var $pos_JC1m_do_mouse=[0, 0];
  var $mpos_3M3u_do_mouse=[0, 0];
  var $sz_8RIG_build_draw=[12, 12];
  var $v1_8ffi_build_draw=new Vector2();
  var $v3_PMw7_build_draw=new Vector2();
  var $clr_6BCs_build_draw=[0, 0, 0, 1];
  var $pos1_YJbm_build_draw=[0, 0];
  var $size_pZXP_do_mouse=[0, 0];
  var $v2_lQC0_build_draw=new Vector2();
  var $v4_N3FW_build_draw=new Vector2();
  _es6_module.add_class(UIColorField);
  UIColorField = _es6_module.add_export('UIColorField', UIColorField);
  var $white_d4aW_build_draw;
  var $grey_lYg__build_draw;
  var UIColorBox=_ESClass("UIColorBox", UIElement, [function UIColorBox(ctx, color) {
    ...
    for (var i=0; i<tot; i++) {
        ...
        for (var j=0; j<tot2; j++) {
            var k=(i+j)%2;
            canvas.box2(pos, wid, k ? $white_d4aW_build_draw : $grey_lYg__build_draw);
            pos[1]+=wid[1];
        }
        pos[0]+=wid[0];
    }
  ...
  var $white_d4aW_build_draw=[1.0, 1.0, 1.0, 1.0];
  var $grey_lYg__build_draw=[0.3, 0.3, 0.3, 1.0];
  _es6_module.add_class(UIColorBox);
  UIColorBox = _es6_module.add_export('UIColorBox', UIColorBox);
  var $hsva_IRbN_update_widgets;
  var $hsva_Ux4v_hsv_callback;
  var UIColorPicker=_ESClass("UIColorPicker", RowFrame, [function UIColorPicker(ctx, color, color_length) {
    ...
    for (var i=0; i<$hsva_IRbN_update_widgets.length; i++) {
        if (isNaN($hsva_IRbN_update_widgets[i])) {
            console.log("Eek, NaN!");
            $hsva_IRbN_update_widgets[i] = 0.0;
        }
    }
    ...
    this.last_valid_hue = rgba_to_hsva(this._color, $hsva_IRbN_update_widgets, this.last_valid_hue);
    if ($hsva_IRbN_update_widgets[1]<0) {
        $hsva_IRbN_update_widgets[1] = this.last_valid_sat;
    }
    else {
      this.last_valid_sat = $hsva_IRbN_update_widgets[1];
    }
    this.field.h = $hsva_IRbN_update_widgets[0]*0.9999;
    this.field.s = $hsva_IRbN_update_widgets[1];
    this.field.v = $hsva_IRbN_update_widgets[2];
    ...
    if (isNaN(this.color[2])) {
        console.log("NaN!", this._color, $hsva_IRbN_update_widgets);
    }
    ...
    $hsva_Ux4v_hsv_callback[0] = h*0.9999;
    $hsva_Ux4v_hsv_callback[1] = s;
    $hsva_Ux4v_hsv_callback[2] = v;
    if (this.color_length==4)
      $hsva_Ux4v_hsv_callback[3] = this._color[3];
    else 
      $hsva_Ux4v_hsv_callback[3] = 1.0;
    this.last_valid_hue = h;
    this.last_valid_sat = s;
    this.last_valid_hue = hsva_to_rgba($hsva_Ux4v_hsv_callback, this._color, h*0.9999);
    this.update_widgets();
    this.on_colorchange();
  }]);
  var $hsva_IRbN_update_widgets=[0, 0, 0, 0];
  var $hsva_Ux4v_hsv_callback=[0, 0, 0, 0];
  ...
  var $zero_uOkJ_build_draw;
  var $size2_ALIH_build_draw;
  var $one_6gGB_build_draw;
  var UIProgressBar=_ESClass("UIProgressBar", UIElement, [function UIProgressBar(ctx, value, min, max, min_wid, min_hgt) {
    ...
    canvas.box($zero_uOkJ_build_draw, this.size, uicolors["ProgressBarBG"]);
    if (perc>0.0) {
        perc = Math.min(Math.max(0.0, perc), 1.0);
        $size2_ALIH_build_draw[1] = this.size[1]-2;
        $size2_ALIH_build_draw[0] = Math.floor(this.size[0]*perc)-2;
        canvas.box($one_6gGB_build_draw, $size2_ALIH_build_draw, uicolors["ProgressBar"]);
    }
    canvas.end(this);
  }]);
  var $zero_uOkJ_build_draw=[0, 0];
  var $size2_ALIH_build_draw=[0, 0];
  var $one_6gGB_build_draw=[1, 1];
  ...
  var $pan_EiOp__vscroll_callback;
  var UIListBox=_ESClass("UIListBox", ColumnFrame, [function UIListBox(ctx, pos, size, callback) {
    ...
    $pan_EiOp__vscroll_callback[1] = value;
    this.listbox.velpan.set_pan($pan_EiOp__vscroll_callback);
  ...
  var $pan_EiOp__vscroll_callback=[0, 0];
...
es6_module_define('UITabPanel', ["UIPack", "mathlib", "UIFrame", "UIElement", "UIWidgets"], function _UITabPanel_module(_es6_module) {
  var MinMax=es6_import_item(_es6_module, 'mathlib', 'MinMax');
  var inrect_2d=es6_import_item(_es6_module, 'mathlib', 'inrect_2d');
  var aabb_isect_2d=es6_import_item(_es6_module, 'mathlib', 'aabb_isect_2d');
  var UIElement=es6_import_item(_es6_module, 'UIElement', 'UIElement');
...
es6_module_define('dialog', ["UIElement", "UICanvas", "UITextBox", "toolops_api", "UIWidgets", "UIFrame", "UIPack", "UIWidgets_special"], function _dialog_module(_es6_module) {
...
es6_module_define('dialogs', ["toolops_api", "UIWidgets_special", "ajax", "svg_export", "spline_createops", "UIElement", "toolprops", "html5_fileapi", "UIWidgets", "UIPack", "UIFrame", "fileapi", "dialog", "config", "strutils", "UITextBox"], function _dialogs_module(_es6_module) {
  var Dialog=es6_import_item(_es6_module, 'dialog', 'Dialog');
  var PackedDialog=es6_import_item(_es6_module, 'dialog', 'PackedDialog');
...
es6_module_define('FrameManager', ["events", "struct", "UIPack", "FrameManager_ops", "ScreenBorder", "UIFrame", "ScreenArea", "toolops_api", "UIElement", "dialogs", "config", "UICanvas", "mathlib"], function _FrameManager_module(_es6_module) {
  "use strict";
  var config=es6_import(_es6_module, 'config');
...
es6_module_define('FrameManager_ops', ["mathlib", "UIPack", "UIElement", "struct", "toolops_api", "dialogs", "ScreenArea", "UICanvas", "UIFrame", "events"], function _FrameManager_ops_module(_es6_module) {
  "use strict";
  var login_dialog=es6_import_item(_es6_module, 'dialogs', 'login_dialog');
  var MinMax=es6_import_item(_es6_module, 'mathlib', 'MinMax');
  var get_rect_lines=es6_import_item(_es6_module, 'mathlib', 'get_rect_lines');
...
es6_module_define('ScreenArea', ["struct", "UICanvas", "toolops_api", "UIWidgets", "mathlib", "dialogs", "events", "UIPack", "UIElement", "UIFrame"], function _ScreenArea_module(_es6_module) {
  "use strict";
  var login_dialog=es6_import_item(_es6_module, 'dialogs', 'login_dialog');
  var MinMax=es6_import_item(_es6_module, 'mathlib', 'MinMax');
  var get_rect_lines=es6_import_item(_es6_module, 'mathlib', 'get_rect_lines');
...
es6_module_define('ScreenBorder', ["events", "UIPack", "dialogs", "config", "UIElement", "mathlib", "FrameManager_ops", "toolops_api", "UIFrame", "UICanvas", "ScreenArea", "struct"], function _ScreenBorder_module(_es6_module) {
  "use strict";
  ...
  var $black_I9cC_on_mousemove;
  var $black_02qi_build_draw;
  var ScreenBorder=_ESClass("ScreenBorder", UIElement, [function ScreenBorder(area, borderindex) {
    ...
    this.canvas.clear();
    this.canvas.line([x, y], [sx, sy], $black_I9cC_on_mousemove, $black_I9cC_on_mousemove);
  }, function finish() {
    if (this.moving) {
        this.canvas.pop_layer();
        this.parent.pop_modal();
    ...
    if (this.moving)
      canvas.line(this.moving_line[0], this.moving_line[1], $black_02qi_build_draw, $black_02qi_build_draw);
  }]);
  var $black_I9cC_on_mousemove=[0, 0, 0, 1];
  var $black_02qi_build_draw=[0, 0, 0, 1];
...
es6_module_define('view2d_editor', ["struct"], function _view2d_editor_module(_es6_module) {
  ...
  var $v3d_idgen_bD5t_View2DEditor=1;
  _es6_module.add_class(View2DEditor);
  View2DEditor = _es6_module.add_export('View2DEditor', View2DEditor);
  View2DEditor.STRUCT = "\n  View2DEditor {\n  }\n";
});
es6_module_define('MaterialEditor', ["spline_types", "UIElement", "UITabPanel", "spline_editops", "ScreenArea", "UICanvas", "toolops_api", "config", "UIWidgets", "spline_layerops", "UIFrame", "events", "struct", "UIPack", "UIWidgets_special", "UITextBox", "mathlib"], function _MaterialEditor_module(_es6_module) {
...
es6_module_define('DopeSheetEditor', ["UIWidgets", "spline_layerops", "toolops_api", "events", "UITabPanel", "UIElement", "struct", "spline_types", "spline_base", "spline_editops", "ScreenArea", "animdata", "dopesheet_ops", "dopesheet_phantom", "UIFrame", "spline_element_array", "mathlib", "UITextBox", "UIPack", "UIWidgets_special", "spline"], function _DopeSheetEditor_module(_es6_module) {
  "use strict";
  var aabb_isect_2d=es6_import_item(_es6_module, 'mathlib', 'aabb_isect_2d');
  var gen_editor_switcher=es6_import_item(_es6_module, 'UIWidgets_special', 'gen_editor_switcher');
  var KeyMap=es6_import_item(_es6_module, 'events', 'KeyMap');
  ...
  var DopeSheetEditor=_ESClass("DopeSheetEditor", Area, [function DopeSheetEditor(pos, size) {
    ...
    function _generator_iter() {
      this.scope = {actlayer_3: undefined, frameset_3: undefined, spline_3: undefined}
    ...
    var __gen_this2=this;
    function _generator_iter() {
      this.scope = {start_y_0: start_y, ch_3: undefined, actlayer_3: undefined, chgt_3: undefined, cwid_3: undefined, __iter_ch_3: undefined, y_3: undefined, spline_3: undefined}
      this.ret = {done: false, value: undefined}
      this.state = 1;
      this.trystack = [];
      this.next = function() {
    ...
    var __gen_this2=this;
    function _generator_iter() {
      this.scope = {vd_1: undefined, chgt_1: undefined, y_1: undefined, __iter_vd_1: undefined, channels_1: undefined}
      this.ret = {done: false, value: undefined}
      this.state = 1;
      this.trystack = [];
      this.next = function() {
...
es6_module_define('dopesheet_transdata', ["animdata", "transdata", "mathlib"], function _dopesheet_transdata_module(_es6_module) {
  "use strict";
  var MinMax=es6_import_item(_es6_module, 'mathlib', 'MinMax');
...
es6_module_define('dopesheet_ops', ["toolprops", "dopesheet_phantom", "animdata", "toolops_api"], function _dopesheet_ops_module(_es6_module) {
  "use strict";
...
es6_module_define('notifications', ["UIWidgets", "UITabPanel", "UIWidgets_special", "UIFrame", "ScreenArea", "UITextBox", "UIElement", "toolops_api", "UIPack"], function _notifications_module(_es6_module) {
  var UIElement=es6_import_item(_es6_module, 'UIElement', 'UIElement');
  var UIFlags=es6_import_item(_es6_module, 'UIElement', 'UIFlags');
  var PackFlags=es6_import_item(_es6_module, 'UIElement', 'PackFlags');
  var CanvasFlags=es6_import_item(_es6_module, 'UIElement', 'CanvasFlags');
...
es6_module_define('manipulator', [], function _manipulator_module(_es6_module) {
  ...
  var ManipulatorManager=_ESClass("ManipulatorManager", [function ManipulatorManager(view2d) {
    ...
    if (this.active!=undefined) {
      ...
      return $nil_4VVE_get_render_rects;
    }
  }, function remove(mn) {
    if (mn==this.active) {
        this.pop();
