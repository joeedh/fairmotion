...
/*
UPDATE: okay, looks like I don't use multiple inheritance.
TODO: rewrite this file.

OLD: at one point during drafting ES6 had multiple inheritance, and well, I ended
up implementing it.  Need to replace with something else.  I think only the dag
events system uses it, if that.
*/
...
/*Object model:
  ...
  A basic multiple-inheritance object model,
  with static methods.
  ...
  Each constructor function has the following properties:
    ...
    prototype.__class__       : constructor.name. This should be removed; 
                                can use __proto__ instead.
...
function simple_inherit_multiple(obj, parents) {
  if (parents.length > 1) {
    startup_warning("Warning: detected multiple inheritance for " +obj.name + "; that feature was removed from ES6");
  }
