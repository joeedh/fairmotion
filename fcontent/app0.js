...
es6_module_define('bezier', [], function _bezier_module(_es6_module) {
  ...
  function dcurv4(x1, y1, x2, y2, x3, y3, x4, y4, s) {
    let df=1e-05;
    let a=curv4(x1, y1, x2, y2, x3, y3, x4, y4, s-df);
    let b=curv4(x1, y1, x2, y2, x3, y3, x4, y4, s+df);
    return (b-a)/(df*2.0);
  }
  dcurv4 = _es6_module.add_export('dcurv4', dcurv4);
  function bez_self_isect4(x1, y1, x2, y2, x3, y3, x4, y4) {
    return ;
    let steps=8;
  ...
  bez_self_isect4 = _es6_module.add_export('bez_self_isect4', bez_self_isect4);
  function lenbez4(x1, y1, x2, y2, x3, y3, x4, y4, s1) {
    const steps=16;
  ...
  lenbez4 = _es6_module.add_export('lenbez4', lenbez4);
  function thbez4(x1, y1, x2, y2, x3, y3, x4, y4, s1) {
    let len=1.0;
    if (s1===0.0) {
