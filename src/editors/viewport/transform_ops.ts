...
export class WidgetResizeOp extends TransformOp {
  ...
  static _get_bounds(minmax: MinMax, spline: Spline, ctx: FullContext) {
    let totsel = 0;
  ...
  static create_widgets(manager: ManipulatorManager, ctx: FullContext) {
    ...
    widget.on_tick = function (ctx: FullContext) {
    ...
    let corner_onclick = function (e: WidgetEvent, view2d: View2DHandler, id: number) {
      let ci = id;
      ...
      let toolop = e.ctrlKey
        ? new ScaleOp(mpos, view2d.selectmode)
        : new NonUniformScaleOp(mpos, view2d.selectmode);
    ...
    larrow.on_click = rarrow.on_click = function (
      e: WidgetEvent,
    ...
    tarrow.on_click = barrow.on_click = function (
      e: WidgetEvent,
      view2d: View2DHandler,
      id: string
    ) {
  ...
  static reset_widgets(op: ToolOp, ctx: FullContext) {}
}
...
export class WidgetRotateOp extends TransformOp {
  ...
  static create_widgets(manager: ManipulatorManager, ctx: FullContext) {
    ...
    circle.on_click = function (e: WidgetEvent, view2d: View2DHandler, id: string) {
      let mpos = new Vector2([e.origX, e.origY]);
      //view2d.project(mpos);
