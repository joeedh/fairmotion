  ...
  class SplineEditor extends View2DEditor {
    ...
    static  fromSTRUCT(reader) {
     ...
     build_bottombar(view2d, col) {
      ...
      let prop=col.prop("view2d.selectmode", PackFlags.USE_SMALL_ICON|PackFlags.ENUM_STRIP);
     ...
     tools_menu(ctx, mpos, view2d) {
      const ops=["spline.key_edges()", "spline.key_current_frame()", "spline.connect_handles()", "spline.disconnect_handles()", "spline.toggle_step_mode()", "spline.toggle_manual_handles()", "editor.paste_pose()", "editor.copy_pose()"];
...
es6_module_define('frameset', ["./struct.js", "../curve/spline_element_array.js", "./animdata.js", "./lib_api.js", "./animspline.js", "../curve/spline.js", "../curve/spline_types.js", "../vectordraw/vectordraw.js", "../curve/spline_draw_new.js", "./animspline"], function _frameset_module(_es6_module) {
  ...
  var SimpleCanvasDraw2D=es6_import_item(_es6_module, '../vectordraw/vectordraw.js', 'SimpleCanvasDraw2D');
  var SimpleCanvasPath=es6_import_item(_es6_module, '../vectordraw/vectordraw.js', 'SimpleCanvasPath');
    ...
    get  _selected_splines() {
     ...
     draw(ctx, g, editor, matrix, redraw_rects, ignore_layers) {
      ...
      if (this.spline.drawer===undefined) {
        ...
        if (this.spline.drawer.drawer.constructor!==cls) {
...
es6_module_define('SettingsEditor', ["../editor_base.js", "../../core/struct.js", "../../path.ux/scripts/pathux.js", "../../path.ux/scripts/screen/ScreenArea.js"], function _SettingsEditor_module(_es6_module) {
  ...
  var reverse_keymap=es6_import_item(_es6_module, '../../path.ux/scripts/pathux.js', 'reverse_keymap');
  var saveUIData=es6_import_item(_es6_module, '../../path.ux/scripts/pathux.js', 'saveUIData');
  var loadUIData=es6_import_item(_es6_module, '../../path.ux/scripts/pathux.js', 'loadUIData');
...
es6_module_define('data_api_define', ["../../editors/viewport/view2d_base.js", "../../editors/viewport/selectmode.js", "../toolprops.js", "../animdata.js", "../../editors/viewport/spline_createops.js", "../../editors/viewport/view2d.js", "../units.js", "../../editors/settings/SettingsEditor.js", "../../editors/ops/ops_editor.js", "../context.js", "../frameset.js", "../../curve/spline_types.js", "../../path.ux/scripts/pathux.js", "../../curve/spline_base.js", "../../curve/spline.js", "../../editors/viewport/toolmodes/toolmode.js", "../../editors/curve/CurveEditor.js", "../UserSettings.js", "../imageblock.js", "../../scene/sceneobject.js", "../lib_api.js", "../toolops_api.js", "../../editors/dopesheet/DopeSheetEditor.js", "../../editors/viewport/toolmodes/splinetool.js", "../../scene/scene.js", "../../curve/spline_element_array.js"], function _data_api_define_module(_es6_module) {
  ...
  var BlockClasses=es6_import_item(_es6_module, '../lib_api.js', 'BlockClasses');
  var DataTypes=es6_import_item(_es6_module, '../lib_api.js', 'DataTypes');
  ...
  function makeAPI(api) {
    ...
    function api_define_View2DHandler(api) {
      ...
      View2DHandlerStruct.bool("half_pix_size", "half_pix_size", "Half Resolution").icon(Icons.HALF_PIXEL_SIZE);
    ...
    function api_define_SplineVertex(api) {
     ...
     BREAK_CURVATURES: Icons.EXTRUDE_MODE_G1}).on("change", function (old) {
      ...
      SplineVertexStruct.float("width", "width", "width").range(-50, 200).step(0.75).expRate(2.5).decimalPlaces(4).on("change", function (old) {
    ...
    function api_define_DataLib(api) {
      ...
      DataLibStruct.list("", "items", [function getIter(api, datalib) {
        return (function* () {
...
es6_module_define('data_api', ["../toolops_api.js"], function _data_api_module(_es6_module) {
...
es6_module_define('keymap', ["../path.ux/scripts/pathux.js"], function _keymap_module(_es6_module) {
  var pathux=es6_import(_es6_module, '../path.ux/scripts/pathux.js');
  class HotKey extends pathux.HotKey {
     constructor() {
      super(...arguments);
  ...
  _ESClass.register(KeyMapDelta);
  _es6_module.add_class(KeyMapDelta);
  KeyMapDelta = _es6_module.add_export('KeyMapDelta', KeyMapDelta);
  KeyMapDelta.STRUCT = `
KeyMapDelta {
  key       : int;
...
`;
  ...
  class KeyMapDeltaSet  {
     constructor(typeName, deltas) {
      this.typeName = typeName;
      this.deltas = deltas||[];
    }
  }
  _ESClass.register(KeyMapDeltaSet);
  _es6_module.add_class(KeyMapDeltaSet);
  KeyMapDeltaSet = _es6_module.add_export('KeyMapDeltaSet', KeyMapDeltaSet);
...
`;
  ...
  class KeyMap extends pathux.KeyMap {
...
}, '/dev/fairmotion/src/core/keymap.js');
