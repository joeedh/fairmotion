...
export class SplineToolMode extends ToolMode {
  ...
  defineKeyMap() {
    ...
    this.keymap = new KeyMap("view2d:spline", [
      new HotKey("PageUp", [], "spline.change_face_z(offset=1)|Move Up"),
      new HotKey("PageDown", [], "spline.change_face_z(offset=-1)|Move Down"),
      new HotKey("G", [], "spline.translate()"),
      new HotKey("S", [], "spline.scale()"),
      new HotKey("R", [], "spline.rotate()"),
      ...
      new HotKey("H", [], "spline.hide()|Hide Selection"),
      new HotKey("H", ["ALT"], "spline.unhide()|Reveal Selection"),
      new HotKey("G", [], "spline.hide(ghost=1)|Ghost Selection"),
      new HotKey("G", [], "spline.unhide(ghost=1)|Unghost Selection"),
