...
_lr_productions = [
  ...
  ('property_id -> GET','property_id',1,'p_property_id','js_parse.py',1676),
  ('property_id -> SET','property_id',1,'p_property_id','js_parse.py',1677),
  ('property_id -> DELETE','property_id',1,'p_property_id','js_parse.py',1678),
  ('property_id -> FOR','property_id',1,'p_property_id','js_parse.py',1679),
  ('property_id -> WHILE','property_id',1,'p_property_id','js_parse.py',1680),
  ('property_id -> CATCH','property_id',1,'p_property_id','js_parse.py',1681),
  ('property_id -> TRY','property_id',1,'p_property_id','js_parse.py',1682),
  ('property_id -> THROW','property_id',1,'p_property_id','js_parse.py',1683),
  ('property_id -> DO','property_id',1,'p_property_id','js_parse.py',1684),
  ('property_id -> FINALLY','property_id',1,'p_property_id','js_parse.py',1685),
  ('property_id -> NUMBER','property_id',1,'p_property_id','js_parse.py',1686),
  ('property_id -> IF','property_id',1,'p_property_id','js_parse.py',1687),
  ('property_id -> ENUM','property_id',1,'p_property_id','js_parse.py',1688),
  ('property_id -> ELSE','property_id',1,'p_property_id','js_parse.py',1689),
  ('property_id -> VAR','property_id',1,'p_property_id','js_parse.py',1690),
  ('property_id -> CONST','property_id',1,'p_property_id','js_parse.py',1691),
  ('property_id -> LET','property_id',1,'p_property_id','js_parse.py',1692),
  ('property_id -> STATIC','property_id',1,'p_property_id','js_parse.py',1693),
  ('property_id -> YIELD','property_id',1,'p_property_id','js_parse.py',1694),
  ('property_id -> FUNCTION','property_id',1,'p_property_id','js_parse.py',1695),
  ('property_id -> RETURN','property_id',1,'p_property_id','js_parse.py',1696),
  ('property_id -> LSBRACKET expr RSBRACKET','property_id',3,'p_property_id','js_parse.py',1697),
  ('property_id_right -> property_id','property_id_right',1,'p_property_id_right','js_parse.py',1709),
  ('property_id_opt -> property_id property_id','property_id_opt',2,'p_property_id_opt','js_parse.py',1715),
  ('property_id_opt -> property_id','property_id_opt',1,'p_property_id_opt','js_parse.py',1716),
  ('star_opt -> TIMES','star_opt',1,'p_star_opt','js_parse.py',1726),
  ('star_opt -> <empty>','star_opt',0,'p_star_opt','js_parse.py',1727),
  ('method -> star_opt property_id_opt LPAREN funcdeflist RPAREN func_type_opt LBRACKET statementlist_opt RBRACKET','method',9,'p_method','js_parse.py',1738),
  ('getset_id -> property_id','getset_id',1,'p_getset_id','js_parse.py',1783),
  ('getset_id -> NUMBER','getset_id',1,'p_getset_id','js_parse.py',1784),
  ('method_def -> method','method_def',1,'p_method_def','js_parse.py',1791),
  ('method_def_error -> method error','method_def_error',2,'p_method_def_error','js_parse.py',1798),
  ('static -> STATIC','static',1,'p_static','js_parse.py',1806),
  ('cls_prefix -> STATIC','cls_prefix',1,'p_cls_prefix','js_parse.py',1810),
  ('cls_prefix -> ID','cls_prefix',1,'p_cls_prefix','js_parse.py',1811),
  ('cls_prefix -> cls_prefix STATIC','cls_prefix',2,'p_cls_prefix','js_parse.py',1812),
  ('cls_prefix -> cls_prefix ID','cls_prefix',2,'p_cls_prefix','js_parse.py',1813),
  ('cls_prefix_opt -> cls_prefix','cls_prefix_opt',1,'p_cls_prefix_opt','js_parse.py',1828),
  ('cls_prefix_opt -> <empty>','cls_prefix_opt',0,'p_cls_prefix_opt','js_parse.py',1829),
  ('typescript_class_property -> CLASS_PROP_PRE cls_prefix_opt ID_COLON COLON var_type SEMI','typescript_class_property',6,'p_typescript_class_property','js_parse.py',1835),
  ('typescript_class_property -> CLASS_PROP_PRE cls_prefix_opt ID_COLON COLON var_type ASSIGN expr_for_arraylit SEMI','typescript_class_property',8,'p_typescript_class_property','js_parse.py',1836),
  ...
  ('member_name -> NEW','member_name',1,'p_member_name','js_parse.py',2649),
  ('member_name -> TRY','member_name',1,'p_member_name','js_parse.py',2650),
  ('member_name -> DELETE','member_name',1,'p_member_name','js_parse.py',2651),
  ('member_name -> FINALLY','member_name',1,'p_member_name','js_parse.py',2652),
  ('member_name -> THROW','member_name',1,'p_member_name','js_parse.py',2653),
  ('member_name -> CATCH','member_name',1,'p_member_name','js_parse.py',2654),
  ('expr -> NUMBER','expr',1,'p_expr','js_parse.py',2658),
  ('expr -> strlit','expr',1,'p_expr','js_parse.py',2659),
  ('expr -> id','expr',1,'p_expr','js_parse.py',2660),
  ('expr -> id_colon','expr',1,'p_expr','js_parse.py',2661),
  ('expr -> id template_ref','expr',2,'p_expr','js_parse.py',2662),
  ('expr -> template_ref','expr',1,'p_expr','js_parse.py',2663),
  ('expr -> array_literal','expr',1,'p_expr','js_parse.py',2664),
  ('expr -> arrow_function','expr',1,'p_expr','js_parse.py',2665),
  ('expr -> exprfunction','expr',1,'p_expr','js_parse.py',2666),
  ('expr -> exprclass','expr',1,'p_expr','js_parse.py',2667),
  ('expr -> obj_literal','expr',1,'p_expr','js_parse.py',2668),
  ('expr -> dynamic_import','expr',1,'p_expr','js_parse.py',2669),
  ('expr -> expr cmplx_assign expr','expr',3,'p_expr','js_parse.py',2670),
  ('expr -> expr cmplx_assign expr COLON var_type SEMI','expr',6,'p_expr','js_parse.py',2671),
  ('expr -> expr RSHIFT expr','expr',3,'p_expr','js_parse.py',2672),
  ('expr -> expr LSHIFT expr','expr',3,'p_expr','js_parse.py',2673),
  ('expr -> expr EXPONENT expr','expr',3,'p_expr','js_parse.py',2674),
  ('expr -> expr DOUBLEQ expr','expr',3,'p_expr','js_parse.py',2675),
  ('expr -> expr LLSHIFT expr','expr',3,'p_expr','js_parse.py',2676),
  ('expr -> expr RRSHIFT expr','expr',3,'p_expr','js_parse.py',2677),
  ('expr -> expr COND_DOT expr','expr',3,'p_expr','js_parse.py',2678),
  ('expr -> expr DOT expr','expr',3,'p_expr','js_parse.py',2679),
  ('expr -> expr DOT member_name','expr',3,'p_expr','js_parse.py',2680),
  ('expr -> expr DOT DELETE','expr',3,'p_expr','js_parse.py',2681),
  ('expr -> expr DOT DEFAULT','expr',3,'p_expr','js_parse.py',2682),
  ('expr -> expr LAND expr','expr',3,'p_expr','js_parse.py',2683),
  ('expr -> expr LOR expr','expr',3,'p_expr','js_parse.py',2684),
  ('expr -> expr BOR expr','expr',3,'p_expr','js_parse.py',2685),
  ('expr -> expr INSTANCEOF expr','expr',3,'p_expr','js_parse.py',2686),
  ('expr -> expr BXOR expr','expr',3,'p_expr','js_parse.py',2687),
  ('expr -> expr BAND expr','expr',3,'p_expr','js_parse.py',2688),
  ('expr -> expr EQUAL expr','expr',3,'p_expr','js_parse.py',2689),
  ('expr -> expr EQUAL_STRICT expr','expr',3,'p_expr','js_parse.py',2690),
  ('expr -> expr NOTEQUAL_STRICT expr','expr',3,'p_expr','js_parse.py',2691),
  ('expr -> expr GTHAN expr','expr',3,'p_expr','js_parse.py',2692),
  ('expr -> expr GTHANEQ expr','expr',3,'p_expr','js_parse.py',2693),
  ('expr -> expr LTHAN expr','expr',3,'p_expr','js_parse.py',2694),
  ('expr -> expr MOD expr','expr',3,'p_expr','js_parse.py',2695),
  ('expr -> expr LTHANEQ expr','expr',3,'p_expr','js_parse.py',2696),
  ('expr -> expr NOTEQUAL expr','expr',3,'p_expr','js_parse.py',2697),
  ('expr -> expr PLUS expr','expr',3,'p_expr','js_parse.py',2698),
  ('expr -> expr MINUS expr','expr',3,'p_expr','js_parse.py',2699),
  ('expr -> expr DIVIDE expr','expr',3,'p_expr','js_parse.py',2700),
  ('expr -> expr TIMES expr','expr',3,'p_expr','js_parse.py',2701),
  ('expr -> expr IN expr','expr',3,'p_expr','js_parse.py',2702),
  ('expr -> expr func_call','expr',2,'p_expr','js_parse.py',2703),
  ('expr -> expr lsbracket_restrict expr rsbracket_restrict','expr',4,'p_expr','js_parse.py',2704),
  ('expr -> expr QEST expr COLON expr','expr',5,'p_expr','js_parse.py',2705),
  ('expr -> expr COMMA expr','expr',3,'p_expr','js_parse.py',2706),
  ('expr -> lparen_restrict expr rparen_restrict','expr',3,'p_expr','js_parse.py',2707),
  ('expr -> expr_uminus','expr',1,'p_expr','js_parse.py',2708),
  ('expr -> expr_uplus','expr',1,'p_expr','js_parse.py',2709),
  ('expr -> not','expr',1,'p_expr','js_parse.py',2710),
  ('expr -> bitinv','expr',1,'p_expr','js_parse.py',2711),
  ('expr -> new','expr',1,'p_expr','js_parse.py',2712),
  ('expr -> inc','expr',1,'p_expr','js_parse.py',2713),
  ('expr -> dec','expr',1,'p_expr','js_parse.py',2714),
  ('expr -> typeof','expr',1,'p_expr','js_parse.py',2715),
  ('expr -> re_lit','expr',1,'p_expr','js_parse.py',2716),
  ('expr_no_list -> NUMBER','expr_no_list',1,'p_expr_no_list','js_parse.py',2775),
  ('expr_no_list -> strlit','expr_no_list',1,'p_expr_no_list','js_parse.py',2776),
  ('expr_no_list -> id','expr_no_list',1,'p_expr_no_list','js_parse.py',2777),
  ('expr_no_list -> id_colon','expr_no_list',1,'p_expr_no_list','js_parse.py',2778),
  ('expr_no_list -> array_literal','expr_no_list',1,'p_expr_no_list','js_parse.py',2779),
  ('expr_no_list -> exprfunction','expr_no_list',1,'p_expr_no_list','js_parse.py',2780),
  ('expr_no_list -> exprclass','expr_no_list',1,'p_expr_no_list','js_parse.py',2781),
  ('expr_no_list -> dynamic_import','expr_no_list',1,'p_expr_no_list','js_parse.py',2782),
  ('expr_no_list -> expr_no_list cmplx_assign expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2783),
  ('expr_no_list -> expr_no_list RSHIFT expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2784),
  ('expr_no_list -> expr_no_list LSHIFT expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2785),
  ('expr_no_list -> expr_no_list LLSHIFT expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2786),
  ('expr_no_list -> expr_no_list RRSHIFT expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2787),
  ('expr_no_list -> expr_no_list COND_DOT expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2788),
  ('expr_no_list -> expr_no_list DOT expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2789),
  ('expr_no_list -> expr_no_list EXPONENT expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2790),
  ('expr_no_list -> expr_no_list LAND expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2791),
  ('expr_no_list -> expr_no_list LOR expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2792),
  ('expr_no_list -> expr_no_list BOR expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2793),
  ('expr_no_list -> expr_no_list INSTANCEOF expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2794),
  ('expr_no_list -> expr_no_list BXOR expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2795),
  ('expr_no_list -> expr_no_list BAND expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2796),
  ('expr_no_list -> expr_no_list EQUAL expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2797),
  ('expr_no_list -> expr_no_list EQUAL_STRICT expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2798),
  ('expr_no_list -> expr_no_list NOTEQUAL_STRICT expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2799),
  ('expr_no_list -> expr_no_list GTHAN expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2800),
  ('expr_no_list -> expr_no_list GTHANEQ expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2801),
  ('expr_no_list -> expr_no_list LTHAN expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2802),
  ('expr_no_list -> expr_no_list MOD expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2803),
  ('expr_no_list -> expr_no_list LTHANEQ expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2804),
  ('expr_no_list -> expr_no_list NOTEQUAL expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2805),
  ('expr_no_list -> expr_no_list PLUS expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2806),
  ('expr_no_list -> expr_no_list MINUS expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2807),
  ('expr_no_list -> expr_no_list DIVIDE expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2808),
  ('expr_no_list -> expr_no_list TIMES expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2809),
  ('expr_no_list -> expr_no_list IN expr_no_list','expr_no_list',3,'p_expr_no_list','js_parse.py',2810),
  ('expr_no_list -> expr_no_list func_call','expr_no_list',2,'p_expr_no_list','js_parse.py',2811),
  ('expr_no_list -> expr_no_list lsbracket_restrict expr rsbracket_restrict','expr_no_list',4,'p_expr_no_list','js_parse.py',2812),
  ('expr_no_list -> expr_no_list QEST expr_no_list COLON expr_no_list','expr_no_list',5,'p_expr_no_list','js_parse.py',2813),
  ('expr_no_list -> lparen_restrict expr rparen_restrict','expr_no_list',3,'p_expr_no_list','js_parse.py',2814),
  ('expr_no_list -> expr_no_list_uminus','expr_no_list',1,'p_expr_no_list','js_parse.py',2815),
  ('expr_no_list -> expr_no_list_uplus','expr_no_list',1,'p_expr_no_list','js_parse.py',2816),
  ('expr_no_list -> not_no_list','expr_no_list',1,'p_expr_no_list','js_parse.py',2817),
  ('expr_no_list -> bitinv_no_list','expr_no_list',1,'p_expr_no_list','js_parse.py',2818),
  ('expr_no_list -> new_no_list','expr_no_list',1,'p_expr_no_list','js_parse.py',2819),
  ('expr_no_list -> inc_no_list','expr_no_list',1,'p_expr_no_list','js_parse.py',2820),
  ('expr_no_list -> dec_no_list','expr_no_list',1,'p_expr_no_list','js_parse.py',2821),
  ('expr_no_list -> typeof_no_list','expr_no_list',1,'p_expr_no_list','js_parse.py',2822),
  ('expr_no_list -> re_lit','expr_no_list',1,'p_expr_no_list','js_parse.py',2823),
  ('expr_uplus -> PLUS expr','expr_uplus',2,'p_expr_uplus','js_parse.py',2882),
  ('expr_no_list_uplus -> PLUS expr_no_list','expr_no_list_uplus',2,'p_expr_no_list_uplus','js_parse.py',2888),
  ('expr_uminus -> MINUS expr','expr_uminus',2,'p_expr_uminus','js_parse.py',2894),
  ('expr_no_list_uminus -> MINUS expr_no_list','expr_no_list_uminus',2,'p_expr_no_list_uminus','js_parse.py',2900),
  ('paren_expr -> LPAREN expr RPAREN','paren_expr',3,'p_paren_expr','js_parse.py',2906),
  ('paren_expr -> LPAREN RPAREN','paren_expr',2,'p_paren_expr','js_parse.py',2907),
  ('assign_opt -> assign','assign_opt',1,'p_assign_opt','js_parse.py',2916),
  ('assign_opt -> <empty>','assign_opt',0,'p_assign_opt','js_parse.py',2917),
  ('expr_opt -> expr','expr_opt',1,'p_expr_opt','js_parse.py',2926),
  ('expr_opt -> <empty>','expr_opt',0,'p_expr_opt','js_parse.py',2927),
  ('re_lit -> REGEXPR','re_lit',1,'p_re_lit','js_parse.py',2936),
  ('simple_var_decl_strict -> VAR id','simple_var_decl_strict',2,'p_simple_var_decl_strict','js_parse.py',2943),
  ('simple_var_decl_strict -> LET id','simple_var_decl_strict',2,'p_simple_var_decl_strict','js_parse.py',2944),
  ('for_var_decl -> expr_opt','for_var_decl',1,'p_for_var_decl','js_parse.py',2961),
  ('for_var_decl -> simple_var_decl_strict','for_var_decl',1,'p_for_var_decl','js_parse.py',2962),
  ('for_var_decl -> simple_var_decl_strict ASSIGN expr','for_var_decl',3,'p_for_var_decl','js_parse.py',2963),
  ('in_or_of -> IN','in_or_of',1,'p_in_or_of','js_parse.py',3001),
  ('in_or_of -> OF','in_or_of',1,'p_in_or_of','js_parse.py',3002),
  ('for_of_expand -> type_modifiers var_expand OF expr','for_of_expand',4,'p_for_of_expand','js_parse.py',3020),
  ('for_decl -> for_var_decl SEMI expr_opt SEMI expr_opt','for_decl',5,'p_for_decl','js_parse.py',3030),
  ('for_decl -> id in_or_of expr','for_decl',3,'p_for_decl','js_parse.py',3031),
  ('for_decl -> simple_var_decl in_or_of expr','for_decl',3,'p_for_decl','js_parse.py',3032),
  ('for_decl -> for_of_expand','for_decl',1,'p_for_decl','js_parse.py',3033),
  ('loop_label_opt -> <empty>','loop_label_opt',0,'p_loop_label_opt','js_parse.py',3050),
  ('loop_label_opt -> ID_COLON COLON','loop_label_opt',2,'p_loop_label_opt','js_parse.py',3051),
  ('for -> loop_label_opt FOR LPAREN for_decl RPAREN statement_nonctrl','for',6,'p_for','js_parse.py',3058),
  ('for -> loop_label_opt FOR LPAREN for_decl RPAREN LBRACKET statementlist_opt RBRACKET','for',8,'p_for','js_parse.py',3059),
  ('ctrl_statement -> statement_nonctrl','ctrl_statement',1,'p_ctrl_statement','js_parse.py',3074),
  ('ctrl_statement -> LBRACKET statementlist_opt RBRACKET','ctrl_statement',3,'p_ctrl_statement','js_parse.py',3075),
  ('ctrl_statement -> SEMI','ctrl_statement',1,'p_ctrl_statement','js_parse.py',3076),
  ('dowhile -> loop_label_opt DO ctrl_statement WHILE paren_expr','dowhile',5,'p_dowhile','js_parse.py',3090),
  ('while -> loop_label_opt WHILE paren_expr statement_nonctrl','while',4,'p_while','js_parse.py',3101),
  ('while -> loop_label_opt WHILE paren_expr LBRACKET statementlist_opt RBRACKET','while',6,'p_while','js_parse.py',3102),
  ('default_case -> DEFAULT COLON statementlist','default_case',3,'p_default_case','js_parse.py',3116),
  ('statementlist_opt -> statementlist','statementlist_opt',1,'p_statementlist_opt','js_parse.py',3122),
  ('statementlist_opt -> <empty>','statementlist_opt',0,'p_statementlist_opt','js_parse.py',3123),
  ('case_clause -> CASE expr COLON statementlist_opt','case_clause',4,'p_case_clause','js_parse.py',3133),
  ('case_clauses -> case_clause','case_clauses',1,'p_case_clauses','js_parse.py',3140),
  ('case_clauses -> case_clauses case_clause','case_clauses',2,'p_case_clauses','js_parse.py',3141),
  ('case_clauses_opt -> case_clauses','case_clauses_opt',1,'p_case_clauses_opt','js_parse.py',3151),
  ('case_clauses_opt -> <empty>','case_clauses_opt',0,'p_case_clauses_opt','js_parse.py',3152),
  ('case_block -> case_clauses','case_block',1,'p_case_block','js_parse.py',3162),
  ('case_block -> case_clauses_opt default_case case_clauses_opt','case_block',3,'p_case_block','js_parse.py',3163),
  ('switch -> SWITCH paren_expr LBRACKET case_block RBRACKET','switch',5,'p_switch','js_parse.py',3185),
  ('with -> WITH paren_expr ctrl_statement','with',3,'p_with','js_parse.py',3193),
  ('if -> IF paren_expr ctrl_statement','if',3,'p_if','js_parse.py',3201),
  ('try -> TRY statement_nonctrl','try',2,'p_try','js_parse.py',3210),
  ('try -> TRY LBRACKET statementlist RBRACKET','try',4,'p_try','js_parse.py',3211),
  ('try -> TRY LBRACKET RBRACKET','try',3,'p_try','js_parse.py',3212),
  ('finally -> FINALLY LBRACKET statementlist_opt RBRACKET','finally',4,'p_finally','js_parse.py',3228),
  ('export_decl -> EXPORT TIMES from_clause SEMI','export_decl',4,'p_export_decl','js_parse.py',3235),
  ('export_decl -> EXPORT export_clause from_clause SEMI','export_decl',4,'p_export_decl','js_parse.py',3236),
  ('export_decl -> EXPORT export_clause SEMI','export_decl',3,'p_export_decl','js_parse.py',3237),
  ('export_decl -> EXPORT var_decl SEMI','export_decl',3,'p_export_decl','js_parse.py',3238),
  ('export_decl -> EXPORT function','export_decl',2,'p_export_decl','js_parse.py',3239),
  ('export_decl -> EXPORT class','export_decl',2,'p_export_decl','js_parse.py',3240),
  ('export_decl -> EXPORT interface','export_decl',2,'p_export_decl','js_parse.py',3241),
  ('export_decl -> EXPORT enum','export_decl',2,'p_export_decl','js_parse.py',3242),
  ('export_decl -> EXPORT DEFAULT function','export_decl',3,'p_export_decl','js_parse.py',3243),
  ('export_decl -> EXPORT DEFAULT enum','export_decl',3,'p_export_decl','js_parse.py',3244),
  ('export_decl -> EXPORT DEFAULT class','export_decl',3,'p_export_decl','js_parse.py',3245),
  ('export_decl -> EXPORT DEFAULT assign','export_decl',3,'p_export_decl','js_parse.py',3246),
  ('export_clause -> LBRACKET RBRACKET','export_clause',2,'p_export_clause','js_parse.py',3326),
  ('export_clause -> LBRACKET exports_list RBRACKET','export_clause',3,'p_export_clause','js_parse.py',3327),
  ('export_clause -> LBRACKET exports_list COMMA RBRACKET','export_clause',4,'p_export_clause','js_parse.py',3328),
  ('exports_list -> export_spec','exports_list',1,'p_exports_list','js_parse.py',3337),
  ('exports_list -> exports_list COMMA export_spec','exports_list',3,'p_exports_list','js_parse.py',3338),
  ('export_spec -> ID','export_spec',1,'p_export_spec','js_parse.py',3351),
  ('export_spec -> ID ID ID','export_spec',3,'p_export_spec','js_parse.py',3352),
  ('catch_tok -> CATCH','catch_tok',1,'p_catch_tok','js_parse.py',3364),
  ('catch -> catch_tok paren_expr statement_nonctrl','catch',3,'p_catch','js_parse.py',3373),
  ('catch -> catch_tok paren_expr LBRACKET statementlist RBRACKET','catch',5,'p_catch','js_parse.py',3374),
  ('else -> ELSE ctrl_statement','else',2,'p_else','js_parse.py',3386),
  ('break -> BREAK','break',1,'p_break','js_parse.py',3394),
  ('break -> BREAK ID','break',2,'p_break','js_parse.py',3395),
  ('continue -> CONTINUE','continue',1,'p_continue','js_parse.py',3405),
  ('continue -> CONTINUE ID','continue',2,'p_continue','js_parse.py',3406),
  ('return -> RETURN expr','return',2,'p_return','js_parse.py',3416),
  ('return -> RETURN','return',1,'p_return','js_parse.py',3417),
  ('yield -> YIELD expr','yield',2,'p_yield','js_parse.py',3427),
  ('yield -> YIELD','yield',1,'p_yield','js_parse.py',3428),
  ('id_no_enum -> ID','id_no_enum',1,'p_id_no_enum','js_parse.py',3437),
  ('id_no_enum -> GET','id_no_enum',1,'p_id_no_enum','js_parse.py',3438),
  ('id_no_enum -> SET','id_no_enum',1,'p_id_no_enum','js_parse.py',3439),
  ('id_no_enum -> STATIC','id_no_enum',1,'p_id_no_enum','js_parse.py',3440),
  ('id_no_enum -> CATCH','id_no_enum',1,'p_id_no_enum','js_parse.py',3441),
  ('id_no_enum -> GLOBAL','id_no_enum',1,'p_id_no_enum','js_parse.py',3442),
  ('id_no_enum -> AWAIT','id_no_enum',1,'p_id_no_enum','js_parse.py',3443),
  ('id_no_enum -> FROM','id_no_enum',1,'p_id_no_enum','js_parse.py',3444),
  ('id -> ID','id',1,'p_id','js_parse.py',3453),
  ('id -> GET','id',1,'p_id','js_parse.py',3454),
  ('id -> SET','id',1,'p_id','js_parse.py',3455),
  ('id -> STATIC','id',1,'p_id','js_parse.py',3456),
  ('id -> CATCH','id',1,'p_id','js_parse.py',3457),
  ('id -> GLOBAL','id',1,'p_id','js_parse.py',3458),
  ('id -> CHAR','id',1,'p_id','js_parse.py',3459),
  ('id -> AWAIT','id',1,'p_id','js_parse.py',3460),
  ('id -> FROM','id',1,'p_id','js_parse.py',3461),
  ('id -> ENUM','id',1,'p_id','js_parse.py',3462),
  ('error_push -> <empty>','error_push',0,'p_error_push','js_parse.py',3833),
  ('error_pop -> <empty>','error_pop',0,'p_error_pop','js_parse.py',3839),
]
