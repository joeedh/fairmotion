es6_module_define('view2d', ["spline_editops", "UICanvas", "UIWidgets_special", "selectmode", "notifications", "toolops_api", "UITabPanel", "video", "events", "manipulator", "UIWidgets", "mathlib", "UIMenu", "imageblock", "ScreenArea", "UIWidgets_special2", "view2d_spline_ops", "spline_createops", "UIElement", "view2d_editor", "RadialMenu", "struct", "UIPack", "spline_draw"], function _view2d_module(_es6_module) {
  "use strict";
  ...
  var canvas_owners=0;
  var $v3d_id_SbOT_View2DHandler;
  var $min_IpS3_make_drawline;
  var $_co_dZFn_project;
  var $_co_SLAB_unproject;
  var $max_P_zq_make_drawline;
  var View2DHandler=_ESClass("View2DHandler", Area, [function View2DHandler(gl, mesh, vprogram, fprogram, drawmats, x, y, width, height, znear, zfar) {
    ...
    this._id = $v3d_id_SbOT_View2DHandler++;
    ...
    drawlines.push(dl);
    var pad=5;
    $min_IpS3_make_drawline[0] = Math.min(v1[0], v2[0])-pad;
    $min_IpS3_make_drawline[1] = Math.min(v1[1], v2[1])-pad;
    $max_P_zq_make_drawline[0] = Math.max(v1[0], v2[0])+pad;
    $max_P_zq_make_drawline[1] = Math.max(v1[1], v2[1])+pad;
    redraw_viewport($min_IpS3_make_drawline, $max_P_zq_make_drawline);
    return dl;
    ...
    $_co_dZFn_project.load(co);
    $_co_dZFn_project[2] = 0.0;
    $_co_dZFn_project.multVecMatrix(this.rendermat);
    co[0] = $_co_dZFn_project[0], co[1] = $_co_dZFn_project[1];
    return co;
  }, function unproject(co) {
    $_co_SLAB_unproject.load(co);
    $_co_SLAB_unproject[2] = 0.0;
    $_co_SLAB_unproject.multVecMatrix(this.irendermat);
    co[0] = $_co_SLAB_unproject[0], co[1] = $_co_SLAB_unproject[1];
    return co;
  ...
  var $v3d_id_SbOT_View2DHandler=0;
  var $min_IpS3_make_drawline=[0, 0];
  var $_co_dZFn_project=new Vector3();
  var $_co_SLAB_unproject=new Vector3();
  var $max_P_zq_make_drawline=[0, 0];
...
es6_module_define('view2d_ops', ["ajax", "events", "spline_draw", "toolops_api", "toolprops", "vectordraw_canvas2d_simple", "spline_draw_new", "struct", "scene", "html5_fileapi", "spline", "frameset"], function _view2d_ops_module(_es6_module) {
  "use strict";
  var ToolOp=es6_import_item(_es6_module, 'toolops_api', 'ToolOp');
  var UndoFlags=es6_import_item(_es6_module, 'toolops_api', 'UndoFlags');
  var ToolFlags=es6_import_item(_es6_module, 'toolops_api', 'ToolFlags');
  ...
  var TouchEventManager=es6_import_item(_es6_module, 'events', 'TouchEventManager');
  var EventHandler=es6_import_item(_es6_module, 'events', 'EventHandler');
  var $v1__wQN_exec_pan;
  var $v2_xLw__exec_pan;
  var ViewRotateZoomPanOp=_ESClass("ViewRotateZoomPanOp", ToolOp, [function ViewRotateZoomPanOp() {
    ...
    var view2d=ctx.view2d;
    $v1__wQN_exec_pan.load(this.mv5);
    $v2_xLw__exec_pan.load(this.mv6);
    $v1__wQN_exec_pan[2] = 0.9;
    $v2_xLw__exec_pan[2] = 0.9;
    ...
    if (isNaN(scenter[2]))
      scenter[2] = 0.0;
    $v1__wQN_exec_pan[2] = scenter[2];
    $v2_xLw__exec_pan[2] = scenter[2];
    $v1__wQN_exec_pan.multVecMatrix(iprojmat);
    $v2_xLw__exec_pan.multVecMatrix(iprojmat);
    var vec=new Vector3($v2_xLw__exec_pan);
    vec.sub($v1__wQN_exec_pan);
  ...
  var $v1__wQN_exec_pan=new Vector3();
  var $v2_xLw__exec_pan=new Vector3();
...
es6_module_define('view2d_spline_ops', ["UIWidgets", "transform_ops", "spline_createops", "UICanvas", "spline_selectops", "events", "spline_draw", "transform", "ScreenArea", "UIWidgets_special", "UIMenu", "spline_multires", "multires_ops", "animdata", "spline", "spline_types", "multires_selectops", "UIPack", "view2d_editor", "selectmode", "struct", "toolops_api", "spline_editops", "UIElement", "lib_api"], function _view2d_spline_ops_module(_es6_module) {
  "use strict";
  ...
  var $ops_4lFZ_tools_menu;
  var $rect_nsjH_handle_mres_mousemove;
  var SplineEditor=_ESClass("SplineEditor", View2DEditor, [function SplineEditor(view2d) {
    ...
    var menu=view2d.toolop_menu(ctx, "Tools", $ops_4lFZ_tools_menu);
    ...
    if (pid!=undefined) {
        ...
        $rect_nsjH_handle_mres_mousemove[0].load(p).subScalar(10);
        $rect_nsjH_handle_mres_mousemove[1].load(p).addScalar(10);
        $rect_nsjH_handle_mres_mousemove[0][2] = $rect_nsjH_handle_mres_mousemove[1][2] = 0.0;
        window.redraw_viewport($rect_nsjH_handle_mres_mousemove[0], $rect_nsjH_handle_mres_mousemove[1]);
    }
  ...
  var $ops_4lFZ_tools_menu=["spline.key_edges()", "spline.key_current_frame()", "spline.connect_handles()", "spline.disconnect_handles()", "spline.toggle_step_mode()", "spline.toggle_manual_handles()", "editor.paste_pose()", "editor.copy_pose()"];
  var $rect_nsjH_handle_mres_mousemove=[new Vector3(), new Vector3()];
...
es6_module_define('frameset', ["lib_api", "spline_types", "spline_element_array", "animdata", "struct", "spline"], function _frameset_module(_es6_module) {
  "use strict";
  var STRUCT=es6_import_item(_es6_module, 'struct', 'STRUCT');
  var DataBlock=es6_import_item(_es6_module, 'lib_api', 'DataBlock');
  var DataTypes=es6_import_item(_es6_module, 'lib_api', 'DataTypes');
...
es6_module_define('ops_editor', ["UIWidgets_special", "UIElement", "ScreenArea", "UITabPanel", "UIPack", "struct", "UITextBox", "events", "UICanvas", "UIFrame", "toolops_api", "UIWidgets"], function _ops_editor_module(_es6_module) {
  var gen_editor_switcher=es6_import_item(_es6_module, 'UIWidgets_special', 'gen_editor_switcher');
  var PackFlags=es6_import_item(_es6_module, 'UIElement', 'PackFlags');
...
es6_module_define('SettingsEditor', ["UITabPanel", "UIPack", "UIFrame", "UIWidgets", "events", "UIWidgets_special", "struct", "UIElement", "toolops_api", "ScreenArea", "UICanvas", "mathlib", "UITextBox"], function _SettingsEditor_module(_es6_module) {
  "use strict";
  var gen_editor_switcher=es6_import_item(_es6_module, 'UIWidgets_special', 'gen_editor_switcher');
...
var ContextStruct;
es6_module_define('data_api_define', ["theme", "toolprops", "spline_multires", "view2d", "lib_api", "ops_editor", "imageblock", "units", "data_api", "spline_base", "config", "selectmode", "spline_createops", "spline_element_array", "toolops_api"], function _data_api_define_module(_es6_module) {
  var DataTypes=es6_import_item(_es6_module, 'lib_api', 'DataTypes');
  ...
  var OpStackArray=new DataStructArray(get_tool_struct, function getitempath(key) {
    ...
    function range(len) {
      ...
      function _generator_iter() {
        this.scope = {i_1: undefined, len_0: len}
        this.ret = {done: false, value: undefined}
        this.state = 1;
        this.trystack = [];
        this.next = function() {
...
var data_ops_list;
es6_module_define('data_api_opdefine', ["transform", "spline_animops", "spline_layerops", "FrameManager_ops", "view2d", "view2d_spline_ops", "image_ops", "view2d_editor", "safe_eval", "dialogs", "toolops_api", "FrameManager", "spline_createops", "spline_editops", "view2d_ops", "spline_selectops"], function _data_api_opdefine_module(_es6_module) {
